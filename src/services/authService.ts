...
export const DEMO_PARTNERS: DeliveryPartner[] = [
  {
    ...
    phone: '9876543210',
    email: 'rahul.delivery@rapidmedicoco.com',
    dob: '1995-08-15',
  ...
  },
  {
    ...
    phone: '9811223344',
    email: 'priya.patel@rapidmedicoco.com',
    dob: '1998-03-22',
  ...
  },
  {
    ...
    fullName: 'Amit Kumar',
    phone: '9988776655',
    email: 'amit.kumar@rapidmedicoco.com',
    dob: '1999-11-05',
  ...
  async verifyAuthOTP(
    ...
    if (signupData) {
      ...
      const newPartner: DeliveryPartner = {
        ...
        phone: cleanPhone,
        email: signupData.email?.trim() || `${cleanPhone}@rapidmedicoco.partner`,
    ...
    const generatedPartner: DeliveryPartner = {
      ...
      phone: cleanPhone,
      email: `driver.${cleanPhone}@rapidmedicoco.com`,
      dob: '1996-05-12',
      vehicleType: 'scooter',
